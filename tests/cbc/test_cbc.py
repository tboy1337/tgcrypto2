...
class TestCBC256Input(unittest.TestCase):
    TYPE_ERROR_PATTERN = r"(('\w+' does not (support|have) the buffer interface)|('a bytes-like object is required, not \'\w+\'')|(a bytes-like object is required, not \'\w+\')|(a bytes-like object is required, not \w+))"
